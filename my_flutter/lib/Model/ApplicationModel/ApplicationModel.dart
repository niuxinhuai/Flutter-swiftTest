...
class ApplicationModel {
  ...
  static final tabsIcon = [
    'AssetFile/tabbar/indexImage.png',
    'AssetFile/tabbar/mainImage.png',
    'AssetFile/tabbar/ownerImage.png',
    'AssetFile/tabbar/secondImage.png',
    'AssetFile/tabbar/userImage.png'
  ];
  static final tabSelectIcon = [
    'AssetFile/tabbar/indexSelectImage.png',
    'AssetFile/tabbar/mainSelectImage.png',
    'AssetFile/tabbar/ownerSelectImage.png',
    'AssetFile/tabbar/secondSelectImage.png',
    'AssetFile/tabbar/userSelectImage.png'
  ];

  static final List<BottomNavigationBarItem> tabArray =
  ...
  static BottomNavigationBarItem getCTab(
      String title, String imagePath, String activeImagePath) {
